...
class st_Admin_Color_Scheme {
	...
	function add_color_scheme() { // child theme
		...
		if ( file_exists( get_stylesheet_directory()."/admin-color.css" ) ) {
			...
			wp_admin_css_color( 'st' , __( 'Custom Admin Colors', 'st-color-scheme' ), get_stylesheet_directory_uri() . '/admin-color.css',
		...
		elseif ( file_exists( get_template_directory()."/admin-color.css" ) ) { // parent theme
			...
			wp_admin_css_color( 'st' , __( 'Custom Admin Colors', 'st-color-scheme' ), get_template_directory_uri() . '/admin-color.css',
			array( '#474247', '#de1e7e', '#ec76b1', '#d51d79' ) // your custom colors as an admin demo
			);
			...
			wp_admin_css_color( 'st' , __( 'Custom Admin Colors', 'st-color-scheme' ), plugins_url( 'st-admin.css', __FILE__ ),
			array( '#474247', '#de1e7e', '#ec76b1', '#d51d79' ) // your custom colors as an admin demo
			);
